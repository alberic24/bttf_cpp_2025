...
HUD::HUD(sf::Font& font) : font(font), healthText("", font, 20), ammoText("", font, 20), weaponText("", font, 20), scoreText("", font, 20) {
...
void HUD::draw(sf::RenderWindow& window, Player* player, int score) {
    ...
    scoreText.setPosition(20.0f, 110.0f);
